$(function () {
  ...
  function setup() {
    ...
    createPlatform(350,600,220,10)
    createPlatform(850,600,220,10)
    createPlatform(600,480,220,10)
    createPlatform(350,360,220,10)
    createPlatform(850,360,220,10)
    createPlatform(600,240,220,10)
    ...
    createCollectable("database",350,600,20,0.5);
    createCollectable("database",350,600,20,0.5);
    createCollectable("database",350,600,20,0.5);
